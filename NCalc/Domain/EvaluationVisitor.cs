    ...
    /// <summary>
        ...
        public override void Visit(BinaryExpression expression)
        {
            ...
            switch (expression.Type)
            {
                ...
                case BinaryExpressionType.BitwiseAnd:
                    Result = Convert.ToUInt64(left()) & Convert.ToUInt64(right());
                    break;
                ...
                case BinaryExpressionType.LeftShift:
                    Result = Convert.ToUInt64(left()) << Convert.ToInt16(right());
                    break;
        ...
        public override void Visit(Function function)
        {
            ...
            switch (function.Identifier.Name.ToLower())
            {
                ...
                #region var
                case "var":
                    CheckCase("var", function.Identifier.Name);

                    if (function.Expressions.Length < 1)
                    {
                        throw new ArgumentException("var() takes 1 argument");
                    }

                    // Visit the identifier by name
                    Visit(new Identifier(Evaluate(function.Expressions[0]).ToString()));

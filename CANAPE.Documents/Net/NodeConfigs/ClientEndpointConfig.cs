...
{
    /// <summary>
    /// Config for a client endpoint
    /// </summary>
    [Serializable]
    public class ClientEndpointConfig : BaseNodeConfig
    {       
        /// <summary>
        /// Name of graph node
        /// </summary>
        public const string NodeName = "client";

        /// <summary>
        /// Get graph node name
        /// </summary>
        /// <returns>Always "client"</returns>
        ...
        {
            return new ClientEndpointFactory(_label, _id);
        }
    }
}
